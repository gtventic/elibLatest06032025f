    ...
    if (isset($_POST['delete_pdf'])) {
        ...
        if ($pdf_record) {
            ...
            if ($stmt->execute()) {
                ...
                // Log the deletion action to pdf_log table.
                $log_stmt = $conn->prepare("INSERT INTO pdf_log (user_id, pdf_file_id, view_time, action, ip_address) VALUES (:user_id, :pdf_file_id, NOW(), 'delete', :ip_address)");
